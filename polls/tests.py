...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_publish_recently() returns True for questions whose pub_date is within the last day.
        """
    ...
    class QuestionIndexViewTests(TestCase):
        ...
        def test_past_question(self):
            ...
            self.assertQuerysetEqual(
                response.context['latast_question_list'],
                ['<Question: Past question.>']
            )

        def test_future_question(self):
            """
            Questions witha pub_date in the future aren't displayed on the index page.
            """
        ...
        def test_two_past_questions(self):
            """
            The questions index page may display nultile questions
            """
    ...
    class QuestionDetailViewTests(TestCase):
        ...
        def test_past_question(self):
            """
            The detail view of a question with a pub_date is the past
